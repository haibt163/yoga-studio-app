      ...
      <main className="flex-grow flex flex-col items-center justify-center px-6 pt-56 pb-20 text-center relative overflow-hidden">
        <div className="max-w-4xl relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link href={`/${locale}/booking`} className="px-8 py-4 bg-stone-900 text-white rounded-full text-xs uppercase tracking-widest hover:bg-stone-800 hover:-translate-y-0.5 transition-all shadow-md w-full sm:w-auto">
