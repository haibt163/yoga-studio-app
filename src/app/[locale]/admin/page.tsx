...
export default function AdminPage() {
      ...
      <div className="min-h-screen flex items-center justify-center font-sans px-6 bg-stone-50">
        <div className="w-full max-w-sm bg-white p-10 rounded-3xl shadow-xl border border-stone-100">
          ...
          <form onSubmit={handleAdminLogin} className="space-y-6">
            <input type="text" value={username} onChange={e => setUsername(e.target.value)} className="w-full border-b border-stone-300 py-2 focus:outline-none focus:border-stone-900 bg-transparent" placeholder="Tài khoản" required />
            <input type="password" value={password} onChange={e => setPassword(e.target.value)} className="w-full border-b border-stone-300 py-2 focus:outline-none focus:border-stone-900 bg-transparent tracking-widest" placeholder="Mật khẩu" required />
  ...
  return (
    <div className="min-h-screen font-sans pb-20 bg-stone-50">
      <nav className="w-full px-8 py-6 bg-white/80 backdrop-blur-md border-b border-stone-200 flex justify-between items-center mb-10 sticky top-0 z-10">
          ...
          <div className="bg-white rounded-[2rem] p-8 max-w-md w-full shadow-2xl">
            ...
            <div className="space-y-6 mb-10">
              <div>
                ...
                <input 
                  type="date"
                  className="w-full p-4 bg-stone-50 border border-stone-200 rounded-xl outline-none focus:border-stone-900 text-stone-600"
                  value={selectedDate}
